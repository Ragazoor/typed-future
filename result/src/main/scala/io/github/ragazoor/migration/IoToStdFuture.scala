...
trait IoToStdFuture {
  implicit def ioToStdFutureF0[E <: Throwable, B](f0: () => Attempt[E, B]): () => StdFuture[B] =
    () => f0().toFuture

  implicit def ioToStdFutureF1[E <: Throwable, X1, B](f1: X1 => Attempt[E, B]): X1 => StdFuture[B] =
    x1 => f1(x1).toFuture

  implicit def ioToStdFutureF2[E <: Throwable, X1, X2, B](f2: (X1, X2) => Attempt[E, B]): (X1, X2) => StdFuture[B] =
    (x1, x2) => f2(x1, x2).toFuture

  implicit def ioToStdFutureF3[E <: Throwable, X1, X2, X3, B](
    f3: (X1, X2, X3) => Attempt[E, B]
  ): (X1, X2, X3) => StdFuture[B] =
    (x1, x2, x3) => f3(x1, x2, x3).toFuture

  implicit def ioToStdFutureF4[E <: Throwable, X1, X2, X3, X4, B](
    f4: (X1, X2, X3, X4) => Attempt[E, B]
  ): (X1, X2, X3, X4) => StdFuture[B] =
    (x1, x2, x3, x4) => f4(x1, x2, x3, x4).toFuture

  implicit def ioToStdFutureF5[E <: Throwable, X1, X2, X3, X4, X5, B](
    f5: (X1, X2, X3, X4, X5) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF6[E <: Throwable, X1, X2, X3, X4, X5, X6, B](
    f6: (X1, X2, X3, X4, X5, X6) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF7[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, B](
    f7: (X1, X2, X3, X4, X5, X6, X7) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF8[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, B](
    f8: (X1, X2, X3, X4, X5, X6, X7, X8) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF9[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, B](
    f9: (X1, X2, X3, X4, X5, X6, X7, X8, X9) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF10[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, B](
    f10: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF11[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, B](
    f11: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF12[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, B](
    f12: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF13[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, B](
    f13: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF14[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, B](
    f14: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF15[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, B](
    f15: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF16[
    ...
    f16: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, X16) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF17[
    ...
    f17: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, X16, X17) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF18[
    ...
    f18: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, X16, X17, X18) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF19[
    ...
    f19: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, X16, X17, X18, X19) => Attempt[E, B]
  ...
  implicit def ioToStdFutureF20[
    ...
    f20: (X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, X16, X17, X18, X19, X20) => Attempt[E, B]
