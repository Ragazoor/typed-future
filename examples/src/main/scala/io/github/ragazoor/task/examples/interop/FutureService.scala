...
/**
 * Imagine this is in a function from a third party library which takes a Future[?] as
 * parameter. In this case we need to convert our Task to Future before passing it to
 * the function.
 */
