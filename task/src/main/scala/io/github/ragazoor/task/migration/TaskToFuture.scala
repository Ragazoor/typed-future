...
trait TaskToFuture {
  implicit def taskToStdFutureF0[E <: Throwable, B](f0: () => Task[E, B]): () => StdFuture[B] =
    () => f0().toFuture

  implicit def taskToStdFutureF1[E <: Throwable, X1, B](f1: X1 => Task[E, B]): X1 => StdFuture[B] =
    x1 => f1(x1).toFuture

  implicit def taskToStdFutureF2[E <: Throwable, X1, X2, B](f2: (X1, X2) => Task[E, B]): (X1, X2) => StdFuture[B] =
    (x1, x2) => f2(x1, x2).toFuture

  implicit def taskToStdFutureF3[E <: Throwable, X1, X2, X3, B](
    f3: (X1, X2, X3) => Task[E, B]
  ): (X1, X2, X3) => StdFuture[B] =
    (x1, x2, x3) => f3(x1, x2, x3).toFuture

  implicit def taskToStdFutureF4[E <: Throwable, X1, X2, X3, X4, B](
    f4: (X1, X2, X3, X4) => Task[E, B]
  ): (X1, X2, X3, X4) => StdFuture[B] =
    (x1, x2, x3, x4) => f4(x1, x2, x3, x4).toFuture

  implicit def taskToStdFutureF5[E <: Throwable, X1, X2, X3, X4, X5, B](
    f5: (X1, X2, X3, X4, X5) => Task[E, B]
  ): (X1, X2, X3, X4, X5) => StdFuture[B] =
    (x1, x2, x3, x4, x5) => f5(x1, x2, x3, x4, x5).toFuture

  implicit def taskToStdFutureF6[E <: Throwable, X1, X2, X3, X4, X5, X6, B](
    f6: (X1, X2, X3, X4, X5, X6) => Task[E, B]
  ): (X1, X2, X3, X4, X5, X6) => StdFuture[B] =
    (x1, x2, x3, x4, x5, x6) => f6(x1, x2, x3, x4, x5, x6).toFuture

  implicit def taskToStdFutureF7[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, B](
    f7: (X1, X2, X3, X4, X5, X6, X7) => Task[E, B]
  ): (X1, X2, X3, X4, X5, X6, X7) => StdFuture[B] =
    (x1, x2, x3, x4, x5, x6, x7) => f7(x1, x2, x3, x4, x5, x6, x7).toFuture

  implicit def taskToStdFutureF8[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, B](
  ...
  implicit def taskToStdFutureF9[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, B](
  ...
  implicit def taskToStdFutureF10[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, B](
  ...
  implicit def taskToStdFutureF11[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, B](
  ...
  implicit def taskToStdFutureF12[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, B](
  ...
  implicit def taskToStdFutureF13[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, B](
  ...
  implicit def taskToStdFutureF14[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, B](
  ...
  implicit def taskToStdFutureF15[E <: Throwable, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, X15, B](
  ...
  implicit def taskToStdFutureF16[
    E <: Throwable,
    X1,
    X2,
    X3,
  ...
  implicit def taskToStdFutureF17[
    E <: Throwable,
    X1,
    X2,
    X3,
  ...
  implicit def taskToStdFutureF18[
    E <: Throwable,
    X1,
    X2,
    X3,
  ...
  implicit def taskToStdFutureF19[
    E <: Throwable,
    X1,
    X2,
    X3,
  ...
  implicit def taskToStdFutureF20[
    E <: Throwable,
    X1,
    X2,
    X3,
  ...
  implicit def taskToStdFutureF21[
    E <: Throwable,
    X1,
    X2,
    X3,
  ...
  implicit def taskToStdFutureF22[
    E <: Throwable,
    X1,
    X2,
    X3,
